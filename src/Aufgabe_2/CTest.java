...
public class CTest {
	...
	//Test: f¸r beide Arrays wird eine null Referenz ¸bergeben
	@Test
    ...
    //Test: f¸r cmp wird eine null Referenz ¸bergeben
	@Test (expected = IllegalArgumentException.class)
	public void combine_Test_2() {
		cInt.combine(array1, array2, null, CircleElement.class);
	}
	
    //Test: f¸r type wird eine null Referenz ¸bergeben
	@Test (expected = IllegalArgumentException.class)
	 ...
	 * insertHead
	 *****************************************************************/
    //Test: list ist null wird ¸bergeben
	@Test
    ...
    //Test:lst enth‰lt nur ein Element
	@Test
